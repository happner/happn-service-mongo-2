...
MongoDataStore.prototype.aggregate = function(criteria, pipeline, options, callback) {
...
MongoDataStore.prototype.find = function(criteria, searchOptions, sortOptions, callback) {
  ...
  if (!sortOptions) return this.data.find(criteria, searchOptions).toArray(callback);
