...
MongoDataStore.prototype.initialize = function(callback){
  ...
  mongoclient.connect (_this.config.url, _this.config.opts, function (err, client) {
    ...
    var db = client.db(_this.config.database);

    var collection = db.collection(_this.config.collection);

    Object.defineProperty(_this, 'data', {value:collection});

    Object.defineProperty(_this, 'connection', {value:client});
...
MongoDataStore.prototype.increment = function(path, counterName, increment, callback){
  ...
  _this.data.update({
    ...
    _this.findOne({path:path}, fields, function(e, found){
